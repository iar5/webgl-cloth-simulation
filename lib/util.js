...
vec3.normalize = function(v) {
	let l = vec3.length(v)
    return new Point(v.x/l, v.y/l, v.z/l)
}

vec3.cross = function(v1, v2) { return new Point(v1.y*v2.z - v1.z*v2.y, v1.z*v2.x - v1.x*v2.z, v1.x*v2.y - v1.y*v2.x)}
vec3.add = function(v1, v2) { return new Point(v1.x + v2.x, v1.y + v2.y, v1.z + v2.z)}
vec3.sub = function(v1, v2) { return new Point(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z)}
vec3.scale = function(v,s) {return new Point(v.x*s, v.y*s, v.z*s)}
